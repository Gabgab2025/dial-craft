...
export function TopNav({ userEmail = "agent@bank.com", userRole = "agent", onLogout }: TopNavProps) {
  ...
  return (
    <header className="glass-card border-b border-glass-border h-16 flex items-center justify-between px-6 sticky top-0 z-50">
      {/* Left Section */}
      <div className="flex items-center space-x-4">
        ...
        <div className="relative max-w-md">
          ...
          <Input
            ...
            className="glass-light border-glass-border pl-10 pr-4 w-80 focus:ring-accent focus:border-accent"
          />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative h-10 w-auto px-3 hover:bg-glass-light">
          ...
          <DropdownMenuContent className="glass-card border-glass-border w-56" align="end" forceMount>
