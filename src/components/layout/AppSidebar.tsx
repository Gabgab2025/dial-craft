...
export function AppSidebar({ userRole = "agent", userEmail = "agent@bank.com", onLogout }: AppSidebarProps) {
  ...
  const userProfile = {
    ...
    position: userRole === "admin" ? "System Administrator" : 
              userRole === "manager" ? "Collections Manager" : "Collections Agent",
    employeeId: "EMP-2024-001",
    hireDate: "January 15, 2023",
    location: "New York Office",
    phone: "+1 (555) 123-4567",
    manager: userRole !== "admin" ? "Sarah Johnson" : null,
    team: userRole === "manager" ? "Team Alpha" : userRole === "agent" ? "Team Alpha" : null,
